...
<head>
    ...
    <title>Регистрация — Beauty Salon</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="auth-container">
    <div class="auth-card">
        <h1>Beauty Salon</h1>
        <p class="subtitle">Создать новый аккаунт</p>
    ...
    <form method="POST" action="${basePath}/auth/register">
        ...
        <div class="form-group">
            ...
            <input type="text" id="lastname" name="lastname" required placeholder="Петров">
        </div>
    ...
    <p class="toggle-link">
        Уже есть аккаунт? <a href="${basePath}/auth/login">Войти</a>
    </p>
</div>
</div>
</body>
